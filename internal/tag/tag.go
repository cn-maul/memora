...
// C3：扩充领域标签（财务/法务/技术/人事/营销/产品/学术/生活），覆盖专业文档
var predefinedTags = []string{
	// 通用办公
	"合同", "报告", "会议纪要", "数据", "图纸", "简历", "发票",
	"方案", "清单", "学习笔记", "通知", "制度", "流程", "分析",
	"审批", "日程", "通讯录", "表单", "模板", "备忘录", "公告",
	// 财务/法务
	"财务报表", "审计报告", "预算", "税务", "会计凭证", "对账单",
	"合同", "协议", "法务", "合规", "诉讼", "授权委托书",
	// 技术/产品
	"技术方案", "架构设计", "API文档", "测试报告", "技术评审",
	"需求文档", "产品原型", "用户手册", "变更说明", "运维手册",
	// 人事/行政
	"人事", "招聘", "绩效", "培训", "员工手册", "考勤", "薪酬",
	// 营销/运营
	"营销", "市场", "品牌", "运营", "数据分析", "竞品分析",
	// 学术/生活
	"论文", "科研", "教材", "食谱", "日程", "总结",
	"其他",
}
...
func (m *Module) ProcessFile(file *contract.FileInfo) error {
	...
	systemPrompt := fmt.Sprintf(
		`你是文档分类助手。从下面的预定义标签库中为文档选择 1~3 个最贴切的标签；仅当确实没有合适标签时，才建议 1~2 个新标签并说明理由。新标签尽量从文档标题或正文高频词中提取。禁止使用禁用词列表中的标签。只输出 JSON，格式：{"tags":["标签1","标签2"],"new_tags":[{"name":"新标签","reason":"理由"}]}
标签库：%s
禁用词：%s`,
