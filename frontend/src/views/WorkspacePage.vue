...
import { browseDir, browseSearch, browseOpen, downloadHistoryVersion, getCommitList, getCommitFiles, getCommitFileContent } from '@/api/client'
...
function openDetailModal(e: BrowseEntry) {
  detailEntry.value = e
